...
const connectionString =
  "mongodb+srv://star-trek-api:qYWJRE2MNtJYlEBz@alien-info.aihxsg1.mongodb.net/?retryWrites=true&w=majority";
...
MongoClient.connect(connectionString, {useUnifiedTopology:true, useNewUrlParser: true}).then(client => {
